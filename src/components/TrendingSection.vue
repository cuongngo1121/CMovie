        ...
        <div class="hidden lg:grid grid-cols-3 gap-8">
            ...
            <div class="aspect-video w-full h-full relative">
              ...
              <div class="absolute bottom-0 left-0 p-8 w-full">
                <div class="flex items-center gap-3 mb-4 flex-wrap">
                  <span class="px-3 py-1 bg-brand text-white text-xs font-bold rounded-md uppercase tracking-wider shadow-sm">
                    #1 Trending
                  </span>
                ...
                <h3 class="text-4xl lg:text-5xl font-bold text-white mb-3 leading-tight group-hover:text-brand-light transition-colors shadow-none">
                  {{ featuredMovie.name }}
                </h3>
                <p class="text-gray-200 text-lg line-clamp-2 mb-6 max-w-2xl text-shadow-sm">
                  {{ stripHtml(featuredMovie.content) }}
                </p>
                
                <div class="flex items-center gap-4">
                  <button class="px-8 py-3 bg-brand hover:bg-brand-hover text-white text-base font-bold rounded-xl flex items-center gap-2 transition-all transform hover:translate-y-[-2px] shadow-sm">
          ...
          <div class="flex flex-col gap-4">
            <div 
              ...
              :key="movie._id"
              class="flex gap-4 p-3 rounded-xl bg-black/20 hover:bg-white/10 backdrop-blur-md border border-white/5 hover:border-white/10 transition-all cursor-pointer group active:scale-[0.98]"
